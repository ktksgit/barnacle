...
void set_result(Tcl_Interp *interp, PyObject *p);
void set_result(Tcl_Interp *interp, pybind11::object pyObj);
...
class interpreter {
  ...
  public:
	...
	details::result getVar(std::string const &scalarTclVariable, int flags);
